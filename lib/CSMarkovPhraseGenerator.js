...
(function () {
  ...
  CS.MarkovPhraseGenerator.prototype = {
    ...
    incorporate_phrase: function (phrase) {
      ...
      phraseLength = phraseNotesWithRestsData.length;
      ...
      if (this._assumeCircular) {
        ...
        for (startStateIndex = i - order; startStateIndex < phraseLength; startStateIndex++) {
         
          // endStateIndex is probably the last note in the phrase.
          endStateIndexPlusOne = Math.min(startStateIndex + order + 1, phraseLength + 1);
