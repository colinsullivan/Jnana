(function () {
  ...
  CS.Ableton.PhraseRenderingClip.prototype = {
    ...
    _generate: function () {
      ...
      generatedPhrase = this._phraseGenerator.generate_phrase(loopLength);
      notes = generatedPhrase.notes();
  ...
  CS.Ableton.SelfGeneratingClip.prototype._generate = function () {
    CS.Ableton.PhraseRenderingClip.prototype._generate.apply(this, arguments);
    this._playsSinceLastGenerate = 0;
  };
