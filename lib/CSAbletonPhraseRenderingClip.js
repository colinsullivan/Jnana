...
(function () {
  ...
  CS.Ableton.PhraseRenderingClip.prototype = {
     ...
     **/
    generate_and_append: function (duration) {
      var generatedPhrase;
      ...
      this.insert_phrase(generatedPhrase, this._currentEndTime);
     ...
     **/
    generate_and_append_async: function (duration, callback) {
      var genTask;
      ...
      genTask = new Task(function (args) {
        this.generate_and_append(args[0]);
        args[1]();
