...
(function () {
  ...
  /**
   *  @class  CSMarkovMultiStateMachine  Utilizes multiple `MarkovTable` instances
  ...
  CS.MarkovMultiStateMachine.prototype = {
     ...
     **/
    start: function () {
      return this._each_table_do("start", arguments);
    },
    ...
    _each_table_do: function (methodName, args) {
      var state = {},
      ...
      for (i = 0; i < stateKeys.length; i++) {
        ...
        state[key] = table[methodName].apply(table, args);
      }
